...
public class ControllerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // if calculator action is called
        if (userPath.equals("/calculator")) {
            // TODO: Implement moving cost calculator
            userPath = "/calculator";
            // if book now action is called
        } else if (userPath.equals("/booking")) {
            // TODO: Implement booking action
            userPath = "/booking";
            // if confirmation action is called
